...
export default {
  ...
  HYDRO_PUMP_BLASTOISE: 'Hydro Pump Blastoise',
  ...
  TECHNO_BLAST_NORMAL: 'Techno Blast (Normal)',
  TECHNO_BLAST_BURN: 'Techno Blast (Burn)',
  TECHNO_BLAST_CHILL: 'Techno Blast (Chill)',
  TECHNO_BLAST_DOUSE: 'Techno Blast (Douse)',
  TECHNO_BLAST_SHOCK: 'Techno Blast (Shock)',
  THUNDER: 'Thunder',
  ...
  WEATHER_BALL_ICE: 'Weather Ball (Ice)',
  WEATHER_BALL_ROCK: 'Weather Ball (Rock)',
  WEATHER_BALL_NORMAL: 'Weather Ball (Normal)',
  WEATHER_BALL_WATER: 'Weather Ball (Water)',
  WILDBOLT_STORM: 'Wildbolt Storm',
  WILD_CHARGE: 'Wild Charge',
  WRAP: 'Wrap',
  WRAP_GREEN: 'Wrap Green',
  WRAP_PINK: 'Wrap Pink',
  X_SCISSOR: 'X-Scissor',
